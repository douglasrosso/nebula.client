...
import { ChevronRight, TrendingUp, Sparkles, Clock, Gift, Loader2 } from "lucide-react";
    ...
    return (
      <main className="min-h-screen pt-20 lg:pt-24 pb-12 flex items-center justify-center">
        <div className="text-center">
          <p className="text-muted-foreground text-lg mb-2">Nenhum jogo disponível no momento.</p>
          <p className="text-sm text-muted-foreground">Verifique se o servidor está rodando.</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <main id="main-content" className="min-h-screen pt-20 lg:pt-24 pb-12">
        ...
        <section className="container mx-auto px-4 mb-12" aria-labelledby="free-games">
          <div className="glass rounded-2xl p-6 border border-success/30 bg-success/5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 id="free-games" className="text-xl font-bold">Jogos Gratuitos</h2>
                <p className="text-sm text-muted-foreground">Jogue agora sem gastar nada</p>
              </div>
            </div>
        ...
        <section className="container mx-auto px-4 mb-12" aria-labelledby="on-sale">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="on-sale" className="text-xl font-bold">Ofertas Especiais</h2>
                <p className="text-sm text-muted-foreground">Aproveite os melhores descontos</p>
              </div>
            </div>
        ...
        <section className="container mx-auto px-4 mb-12" aria-labelledby="popular-games">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="popular-games" className="text-xl font-bold">Mais Populares</h2>
                <p className="text-sm text-muted-foreground">Os jogos mais jogados pela comunidade</p>
              </div>
            </div>
      ...
      <section className="container mx-auto px-4 mb-12" aria-labelledby="new-releases">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="new-releases" className="text-xl font-bold">Lançamentos Recentes</h2>
              <p className="text-sm text-muted-foreground">Os jogos mais recentes na loja</p>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4" aria-labelledby="categories">
        <h2 id="categories" className="text-xl font-bold mb-6">Explorar por Categoria</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {["Ação", "RPG", "Aventura", "Estratégia", "Corrida", "Terror"].map((category) => (
            <Link
              key={category}
