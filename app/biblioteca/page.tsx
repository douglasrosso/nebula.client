          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                {libraryGames.length} jogos na sua biblioteca
              </p>
            </div>
            ...
            <TabsList className="glass">
              <TabsTrigger value="library" className="gap-2">
                ...
                Biblioteca ({libraryGames.length})
              </TabsTrigger>
            ...
            {filteredLibrary.length === 0 ? (
              <div className="glass rounded-2xl p-12 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  {library.length === 0
                    ? "Compre jogos na loja para adicioná-los à sua biblioteca."
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-sm text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {Math.floor(Math.random() * 100)}h jogadas
                        </span>
                      </div>
                    </div>
                    <Button size="sm" className="gap-2">
          ...
          <TabsContent value="wishlist" className="space-y-6">
            {wishlistGames.length === 0 ? (
              <div className="glass rounded-2xl p-12 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Adicione jogos à lista de desejos para acompanhar promoções.
                </p>
                <Link href="/loja">
                  <Button>Explorar loja</Button>
                </Link>
